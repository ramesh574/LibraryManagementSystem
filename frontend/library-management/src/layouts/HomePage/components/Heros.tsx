                    ...
                    <div className='col-4 col-md-4 container d-flex justify-content-center align-items-center'>
                        <div className='ml-2'>
                            ...
                            {authState?.isAuthenticated ? 
                                <Link type='button' className='btn bg-tone btn-lg text-black'
                                    to='search'>Explore top books</Link>
                                :
                                <Link className='btn bg-tone btn-lg text-black' to='/login'>Sign up</Link>
                        }
                        </div>
                    </div>
                </div>
                    ...
                    <div className='col-4 col-md-4 container d-flex 
                        ...
                        <div className='ml-2'>
                            ...
                            <p className='lead'>
                                ...
                                for our library Read students! We are diligent about our book selection 
